...
<body
    ...
    <script type="text/javascript"
        src="https://magnacartacollege.ac.uk/wp-content/plugins/woocommerce/assets/js/frontend/single-product.min.js?ver=5.8.0"
        id="wc-single-product-js"></script>
    <div id='icon_wrapper'><a target="_blank" class='fuse_social_icons_links' data-nonce='e596fd85c1'
            data-title='facebook' href='https://www.facebook.com/magnacartacollege.ac.uk'> <i
                class='fa fa-facebook facebook-awesome-social awesome-social'></i></a><a target="_blank"
            class='fuse_social_icons_links' data-nonce='e596fd85c1' data-title='twitter'
            href='https://twitter.com/magnacarta_ox'> <i
                class='fa fa-twitter twitter-awesome-social awesome-social'></i></a><a target="_blank"
            class='fuse_social_icons_links' data-nonce='e596fd85c1' data-title='linkedin'
            href='https://www.linkedin.com/company/magnacartacollege.ac.uk/'> <i
                class='fa fa-linkedin linkedin-awesome-social awesome-social'></i></a><a target="_blank"
            class='fuse_social_icons_links' data-nonce='e596fd85c1' data-title='youtube'
            href='https://www.youtube.com/channel/UCiPnaoMaZ-rpShQgYO5qj9g'> <i
                class='fa fa-youtube youtube-awesome-social awesome-social'></i></a><a target="_blank"
            class='fuse_social_icons_links' data-nonce='e596fd85c1' data-title='instagram'
            href='https://www.instagram.com/magnacartaoxford/'> <i
                class='fa fa-instagram instagram-awesome-social awesome-social'></i></a></div>
</body>
